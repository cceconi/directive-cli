...
it('generates all github copilot files for github-copilot tool', function (): void {
    ...
    $prompts = [
        ...
        'directive-project', 'directive-stack', 'directive-discuss',
    ];
    ...
    $skills = [
        ...
        'directive-archive-change', 'directive-project-context', 'directive-stack-context', 'directive-discuss-context',
    ];
...
it('generates all antigravity files for antigravity tool', function (): void {
    ...
    $workflows = [
        ...
        'project-context', 'stack-context', 'discuss-session',
    ];
